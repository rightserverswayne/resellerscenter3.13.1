        ...
        <div class="col-md-6">
            <center>
                ...
                <div class="rc-invoice-actions">
                    <button class="publishBtn btn btn-sm btn-success btn-inverse">{$MGLANG->T('edit', 'details', 'publish')}</button>
                    <button class="publishAndSendBtn btn btn-sm btn-warning btn-inverse">{$MGLANG->T('edit', 'details', 'publishAndSend')}</button>
                    <br>

                    <button class="markPaidBtn btn btn-sm btn-info btn-inverse">{$MGLANG->T('edit', 'details', 'markPaid')}</button>
                    <button class="markUnpaidBtn btn btn-sm btn-default btn-inverse">{$MGLANG->T('edit', 'details', 'markUnpaid')}</button>
                    <button class="markCancelledBtn btn btn-sm btn-default btn-inverse">{$MGLANG->T('edit', 'details', 'markCancelled')}</button>
                </div>
    ...
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th style="text-align: center;">{$MGLANG->T('edit', 'details', 'taxed')}&nbsp;&nbsp;</th>
            </tr>
        </thead>
        <tbody>
            <tr class="rc-invoice-summary">
                <td>{$MGLANG->T('edit', 'details', 'subtotal')}:</td>
                <td class='rc-invoice-summary-subtotal'></td>
                <td></td>
            </tr>
            <tr class="rc-invoice-summary" style="display: none;">
                <td class='rc-invoice-summary-tax1'><span class="rc-invoice-taxrate"><span>% {$MGLANG->T('edit', 'details', 'tax')} {$taxes.tax1->name}:</td>
                <td class='rc-invoice-summary-tax1amount'></td>
                <td></td>
            </tr>
            <tr class="rc-invoice-summary" style="display: none;">
                <td class='rc-invoice-summary-tax2'><span class="rc-invoice-taxrate2"><span>% {$MGLANG->T('edit', 'details', 'tax')} {$taxes.tax2->name}:</td>
                <td class='rc-invoice-summary-tax2amount'></td>
                <td></td>
            </tr>
            <tr class="rc-invoice-summary">
                <td>{$MGLANG->T('edit', 'details', 'total')}:</td>
                <td class='rc-invoice-summary-total'></td>
                <td></td>
            </tr>
            <tr class="rc-invoice-summary">
                <td>{$MGLANG->T('edit', 'details', 'credit')}:</td>
