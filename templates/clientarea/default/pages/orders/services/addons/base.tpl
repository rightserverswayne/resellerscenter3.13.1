...
*}
<div id="RCAddonsTabFilters" class="row">
    {include file='services/addons/filters.tpl'}
</div>
{include file='services/addons/export.tpl'}
<div class="row">
    <div class="col-md-12">
        <table class="table table-hover" width="100%">
            <thead>
                <th>{$MGLANG->T('table','id')}&nbsp;&nbsp;</th>
                <th>{$MGLANG->T('table','addon')}&nbsp;&nbsp;</th>
...
{include file='services/addons/delete.tpl'}

<script type="text/javascript">
    {include file='services/addons/controller.js'}
</script>