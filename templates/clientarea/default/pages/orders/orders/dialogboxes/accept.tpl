    ...
    <div class="modal-dialog">
        <div class="modal-content">
                        ...
                        <div class="col-md-12">
                            <div class="note note-warning">
                                {if not $reseller->settings->admin->resellerInvoice}
                                    {$MGLANG->T('accept','unpaid', 'withoutRcInvoice')} 
                                {else}
                                    {$MGLANG->T('accept','unpaid', 'rcInvoice')} <br /> <br />
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success btn-inverse" onclick='ResellersCenter_Orders.submitAcceptForm();'>{$MGLANG->absoluteT('form','button','confirm')}</button>
