                ...
                <div class="box-title tabbable-line pull-right">
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#RCInvoiceEditDetails" aria-controls="RCInvoiceEditDetails" role="tab" data-toggle="tab">{$MGLANG->T('invoices', 'edit', 'details', 'title')}</a>
                        </li>
                        <li role="presentation">
                            <a href="#RCInvoiceEditTransactions" aria-controls="RCInvoiceEditTransactions" role="tab" data-toggle="tab">{$MGLANG->T('invoices', 'edit', 'transactions','title')}</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="modal-body">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="RCInvoiceEditDetails">
                        {include file='details/invoices/edit/details.tpl'}
                    </div>
                    <div role="tabpanel" class="tab-pane" id="RCInvoiceEditTransactions">
                        {include file='details/invoices/edit/transactions.tpl'}
                    </div>
                </div>
...
<script type="text/javascript">
    {include file='details/invoices/edit/controller.js'}
</script>