    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger btn-inverse" onclick='ResellersCenter_ClientsServices.submitSuspendFrom();'>{$MGLANG->T('suspend','buttons','confirm')}</button>
...
<div id="RCUnsuspendService" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-warning btn-inverse" onclick='ResellersCenter_ClientsServices.submitUnsuspendFrom();'>{$MGLANG->T('unsuspend','buttons','confirm')}</button>
