<div class="mg-wrapper body" data-target=".body" {*data-spy="scroll" *}data-twttr-rendered="true">
    ...
    {if !$isWHMCS72}<link rel="stylesheet" type="text/css" href="{$assetsURL}/css/jquery.dataTables.css" />{/if}
    ...
    <link rel="stylesheet" type="text/css" href="{$assetsURL}/css/resellers-center.css" />
    ...
    {if $isWHMCS78}<script type="text/javascript" src="{$assetsURL}/js/jquery-ui.min.js"></script>{/if}
    <script type="text/javascript" src="{$assetsURL}/js/jquery.resize.min.js"></script>
    <script type="text/javascript" src="{$assetsURL}/js/customPagination.js"></script>
    ...
    <script src="{$assetsURL}/js/RCHelper.js" type="text/javascript"></script>
            ...
            <div class="page-content" id="MGPage{$currentPageName}">
                <div class="container-fluid">
                    <ul class="breadcrumb">
                        ...
                        {if $breadcrumbs[0]}
                            <li>
                                {if $breadcrumbs[0].disableLink}
                                    <span style="color: #98aeb5;">{$MGLANG->T('pagesLabels','label', $breadcrumbs[0].name)}</span>
                                {else}
