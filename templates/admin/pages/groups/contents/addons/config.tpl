...
<div id="addonConfigModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id='addonConfigForm' action=''>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success btn-inverse" onclick='RC_SettingsAddons.submitConfigForm()'>{$MGLANG->T('settings','content','config','save')}</button>
